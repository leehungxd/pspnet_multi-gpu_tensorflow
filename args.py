...
parser.add_argument('--visible_gpus', type=str, default='0, 1', help='0,1,2')
...
parser.add_argument('--weight_decay_rate2', type=float, default=0.001, help='weight decay rate for new layers')
...
parser.add_argument('--fine_tune_filename', type=str,
                    default='./z_pretrained_weights/model.ckpt-8925',
                    help='fine_tune_filename')
parser.add_argument('--new_layer_names', type=str, default=None, help='new layers names.')
parser.add_argument('--train_max_iter', type=int, default=89250, help='Maximum training iteration')
parser.add_argument('--snapshot', type=int, default=2975, help='snapshot every ')
